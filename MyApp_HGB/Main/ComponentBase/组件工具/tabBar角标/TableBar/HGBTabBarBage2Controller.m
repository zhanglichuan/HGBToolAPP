...
- (void)viewDidLoad {
    ...
    [self viewSetUp];//UI
     [[HGBTabBarBadgeTool shareInstance] setTabBarBadgeColor:[UIColor blueColor] inController:self];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.section==0){
        if(indexPath.row==0){
            [[HGBTabBarBadgeTool shareInstance] setTabBarBadge:@"x" inController:self];
            NSLog(@"设置成功");
