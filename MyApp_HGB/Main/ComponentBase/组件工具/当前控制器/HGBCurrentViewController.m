...
@interface HGBCurrentViewController ()
/**
 数据源
 */
...
@implementation HGBCurrentViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.section==0){
        if(indexPath.row==0){
            NSLog(@"currentViewController:%@",[HGBCurrentControllerTool currentViewController]);
        }
    }
}
