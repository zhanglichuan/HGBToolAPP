...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.section==0){
        if (indexPath.row==0){
            ...
            [[HGBNetWorkTool shareInstance] post:@"http://liyingtong.com/cttx/gasStationList" params:dic andWithSuccessBlock:^(id responseObject) {
            ...
            [[HGBNetWorkTool shareInstance] get:@"http://liyingtong.com/cttx/gasStation/213" params:@{} andWithSuccessBlock:^(id responseObject) {
            ...
            NSLog(@"文件上传-暂无测试借口");
            [[HGBNetWorkTool shareInstance] uploadFileWithUrl:@"http://192.168.1.107:8081/file_upload" WithData:UIImagePNGRepresentation([UIImage imageNamed:@"icon"]) fileName:@"1.png" andWithSuccessBlock:^(id responseObject) {
