...
@interface HGBAPPStatusViewController ()
/**
 数据源
 */
...
@implementation HGBAPPStatusViewController
...
-(void)viewSetUp{
    ...
    self.dataDictionary=@{@"app状态工具":@[@"app状态"]};
    self.keys=@[@"app状态工具"];
