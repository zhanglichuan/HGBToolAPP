...
@implementation HGBLogController
...
-(void)viewSetUp{
    ...
    self.dataDictionary=@{@"日志重定向":@[@"日志重定向",@"获取日志路径列表",@"获取日志列表"],@"自定义日志":@[@"打印自定义日志",@"打印自定义日志路径列表",@"打印自定义日志列表"]};
    self.keys=@[@"日志重定向",@"自定义日志"];
