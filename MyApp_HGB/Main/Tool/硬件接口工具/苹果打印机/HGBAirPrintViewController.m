...
@interface HGBAirPrintViewController ()<HGBAirPrintToolDelegate>
/**
 数据源
 */
...
@implementation HGBAirPrintViewController
...
-(void)viewSetUp{
    ...
    self.dataDictionary=@{@"苹果隔空打印机":@[@"打印pdf"]};
    self.keys=@[@"苹果隔空打印机"];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.section==0){
        ...
        if (indexPath.row==0){
            [[HGBAirPrintTool shareInstance]  setDelegate:self];
            [[HGBAirPrintTool shareInstance] printWithSource:@"project://test.pdf"];
        }
