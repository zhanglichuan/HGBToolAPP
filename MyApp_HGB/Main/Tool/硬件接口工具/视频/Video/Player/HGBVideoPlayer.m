...
@interface HGBVideoPlayer ()<ZFPlayerDelegate>
/**
 播放器
 */
...
#pragma mark UI
-(void)viewSetUp{
    NSString *lastUrl=[self urlAnalysis:self.url];
    NSURL *videoURL=[NSURL URLWithString:lastUrl];
