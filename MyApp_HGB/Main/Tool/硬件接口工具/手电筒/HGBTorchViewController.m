...
@interface HGBTorchViewController ()
/**
 数据源
 */
...
@implementation HGBTorchViewController
#pragma mark life
- (void)viewDidLoad {
    [super viewDidLoad];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.section==0){
        ...
        if (indexPath.row==0){
            [HGBTorchTool startOnTorch];
        }else if(indexPath.row==1){
            [HGBTorchTool startOffTorch];
        }
